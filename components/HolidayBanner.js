    ...
    >
      <div className={styles.col1}>
        ...
        <p className={styles.bannerText}>
          Please Click here if you are looking for your downloadable holiday
          pictures you purchased from us at one of the malls.
        </p>
      </div>
      <div className={styles.col2}>
        {holidayPhotos.map((photo, i) => (
          <div className={styles.imgWrapper} key={i}>
            <img className={styles.img} src={photo.img} alt="" />
          </div>
        ))}
      </div>
    </a>
